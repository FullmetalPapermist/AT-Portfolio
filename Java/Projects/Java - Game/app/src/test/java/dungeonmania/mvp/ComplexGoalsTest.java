...
public class ComplexGoalsTest {
    ...
    @Test
    @Tag("14-6")
    @DisplayName("Testing a map with 5 conjunction goal")
    public void andAllEnemy() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_complexGoalsTest_enemyAndAll", "c_complexGoalsTest_enemyAndAll");
    ...
    @Test
    @Tag("14-6")
    @DisplayName("Testing enemy goal completed when spawner is blown up")
    public void spawnerDestroyed() throws InvalidActionException {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_complexGoalsTest_spawnerDestroyed", "c_complexGoalsTest_spawnerDestroyed");
