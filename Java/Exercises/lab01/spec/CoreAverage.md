...
6. You can test your code by running the test located in [`app/src/test/java/average/AverageTest.java`](/app/src/test/java/average/AverageTest.java). <br/>
   ...
   - If you have any issues running the tests, see the [Setup Troubleshooting](https://nw-syd-gitlab.cseunsw.tech/COMP2511/24T1/content/-/blob/main/setup/docs/SetupTroubleshooting.md) guide which is also linked on Webcms3.
