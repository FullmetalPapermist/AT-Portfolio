...
public class FlowerSystem {
    ...
    private void routeHarvest(String[] args) {
        ...
        case "rose":
            // gross casting
            List<Rose> harvestedRoses = (List<Rose>) (List<?>) roseBox.harvestFlowers();
        ...
        case "sunflower":
            // gross casting
            List<Sunflower> harvestedSunflowers = (List<Sunflower>) (List<?>) sunflowerBox.harvestFlowers();
    ...
    private boolean command(String[] args) {
        ...
        case "sell":
            ...
            break;
        case "mutate":
            System.out.println("Mutation not supported in this package. "
                    + "You might have meant to run the code in the other package");
            break;
        case "s":
