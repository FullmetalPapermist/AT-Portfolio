...
import metrics.Plot;
import metrics.Strategy.AllPoints;
import metrics.Strategy.Average;
import metrics.Strategy.Max;
import metrics.Strategy.Strategy;
import metrics.Strategy.Sum;
...
public class Panel extends JPanel {
    ...
    public Panel(Plot plot, Strategy strategy) {
        this.plot = plot;
